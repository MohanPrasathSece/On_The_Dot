                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-12">
                    ...
                    <div className="flex items-center gap-6 bg-background p-6 rounded-xl border border-border/50">
                        ...
                        <div>
                            ...
                            <Link to="/signup" className="text-sm font-semibold text-primary hover:underline">Submit Request →</Link>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-6 bg-background p-6 rounded-xl border border-border/50">
                        ...
                        <div>
                            ...
                            <Link to="/signup" className="text-sm font-semibold text-primary hover:underline">Check Status →</Link>
                        </div>
                    </div>
                </div>
            </div>
