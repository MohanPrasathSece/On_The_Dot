    ...
    <section className="py-24 bg-yellow-400 text-black overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10 text-center">
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
          ...
          <br />
          <span className="text-black">Ready to get paid with Flowryte?</span>
        </h2>
        <p className="text-xl text-black/80 max-w-3xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
          <Link to="/signup">
            <Button size="lg" className="h-14 px-8 text-lg bg-black text-white hover:bg-black/90 font-bold w-full sm:w-auto">
              Start Free Trial
            </Button>
          </Link>
          <Link to="/company/com-contact">
            <Button size="lg" variant="outline" className="h-14 px-8 text-lg border-yellow-400 bg-yellow-400 text-black hover:bg-yellow-300 font-bold w-full sm:w-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-black/70">
